...
class KnowledgeGraph(object):
    ...
    def _create_lookup_table(self):
        lookup_table = {}
        self.spo_file_paths.append('./brain/kgs/sent.spo')
    ...
    def add_knowledge_with_vm(self, sent_batch, max_entities=config.MAX_ENTITIES, add_pad=True, max_length=32):
        ...
        for split_sent in split_sent_batch:
            ...
            if len(know_sent) < max_length:
                ...
                visible_matrix = np.pad(visible_matrix, ((0, pad_num), (0, pad_num)), 'constant')
            else:
